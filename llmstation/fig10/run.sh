#!/bin/bash
# $1 - download dir
# $2 - Number of tasklets performed in forward pass before preemption
# $3 - Wait in seconds after preemption in forward pass
# $4 - Number of tasklets performed in backward pass before preemption
# $5 - Wait in seconds after preemption in backward pass

if [[ $# -lt 5 ]]; then
    echo "Too few arguments. "
    echo "Usage $0 <download dir> <forward tasklets> <forward wait> <backward tasklets> <backward wait>"
    exit
fi
