...
def run_whole_peft_step(
    ...
    loss = whole_peft_forward(model=model, inputs=inputs)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--attn_impl", type=str, default="mem_efficient", choices=["eager", "flash_attention_2", "math", "mem_efficient"], help="torch attention implementation")
